...
class CommentsRepositoryTest {
    ...
    void findByArticleId() {
        // expected
        Long article_id = 4L;
        Article article = new Article(4L, "Movie", "Leave comments", null);
    ...
    void findByUsername() {
        ...
        Article article1 = new Article(4L, "Movie", "Leave comments", null);
        Article article2 = new Article(5L, "Country", "Leave comments", null);
